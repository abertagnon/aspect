                ...
                if (merge && useOverlay && !graph) {
                    ...
                    for (Map.Entry<String, List<String>> commandOverlaysInterval : frameCommandMapOverlaysInterval.entrySet()) {
                        if (commandOverlaysInterval.getKey() != null)
                            for (String tikzCommand : commandOverlaysInterval.getValue())
                                out.println("  \\onslide" + commandOverlaysInterval.getKey() + "  " + tikzCommand);
                        else for (String tikzCommand : commandOverlaysInterval.getValue())
